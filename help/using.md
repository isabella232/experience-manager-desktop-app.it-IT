...
* **[!UICONTROL Delete]** azione: Eliminate la risorsa dall&#39;archivio DAM del Experience Manager . L’azione elimina la copia originale della risorsa sul server del Experience Manager . Se desiderate eliminare solo le modifiche apportate alla risorsa locale, consultate [scartare le modifiche](using.md#edit-assets-upload-updated-assets).
...
1. Effettuate ricerche utilizzando le parole chiave per trovare una risorsa correlata nell’archivio del Experience Manager . Utilizzare `?` e `*` come caratteri jolly. Questi caratteri jolly sostituiscono rispettivamente un singolo carattere o più caratteri. Filtrate e ordinate i risultati come necessario.
...
## Modificare le risorse e caricare le risorse aggiornate su  Experience Manager {#edit-assets-upload-updated-assets}
...
Gli utenti possono aggiungere nuove risorse all&#39;archivio DAM. Ad esempio, potete essere un fotografo di agenzia o un appaltatore che desidera aggiungere un gran numero di foto da una fotografia al repository del Experience Manager . Per aggiungere nuovo contenuto  Experience Manager, fate clic sull&#39;icona ![](assets/do-not-localize/upload_to_cloud_da2.png) Carica nel cloud nella barra superiore dell&#39;app. Individuate i file di risorse nel file system locale e fate clic su **[!UICONTROL Select]**. L&#39;app avvia il caricamento della risorsa e visualizza una barra di avanzamento in basso se il caricamento della risorsa richiede più tempo. Non utilizzate spazi bianchi e caratteri non validi durante la creazione o il caricamento di cartelle. Consultate l’elenco dei caratteri in [Creazione delle cartelle in [!DNL Assets]](https://experienceleague.adobe.com/docs/experience-manager-65/assets/managing/manage-assets.html#creating-folders).
...
>[!NOTE]
>
>Se il caricamento dei file non riesce e se vi state connettendo  Experience Manager 6.5.1 o una distribuzione successiva, consultate queste informazioni [sulla](troubleshoot.md#upload-fails)risoluzione dei problemi.
...
>[!NOTE]
>
>Non utilizzate la funzionalità di caricamento per migrare le risorse tra due distribuzioni  Experience Manager. Consultate la guida [alla](https://experienceleague.adobe.com/docs/experience-manager-65/assets/administer/assets-migration-guide.html)migrazione.

### Elenco delle attività trasferite {#list-of-transferred-assets}

Per visualizzare l’elenco delle risorse trasferite in una determinata sessione, consultate [Caricare le risorse in  Experience Manager](#upload-and-add-new-assets-to-aem).
...
Se una risorsa scaricata localmente viene aggiornata sul server di Experience Manager , l&#39;app visualizza uno **[!UICONTROL Modified remotely]** stato. Per rimuovere la copia locale o aggiornare la copia locale, fare clic [!UICONTROL Remove] o [!UICONTROL Update] rispettivamente. I collegamenti presenti nella finestra di dialogo consentono di visualizzare entrambe le versioni della risorsa.
...
1. Tenete a portata di mano un file INDD con le risorse inserite in  Experience Manager. Per sapere come creare un tale file INDD, consulta [Inserimento di elementi grafici](https://helpx.adobe.com/indesign/using/placing-graphics.html).
...
Quando utilizzate l’ [!UICONTROL Edit] azione per modificare una risorsa in un’applicazione desktop nativa, la risorsa viene scaricata localmente se non è già disponibile localmente. Consultate [Modificare le risorse e caricare le risorse aggiornate  Experience Manager](#edit-assets-upload-updated-assets).

Se l&#39;app è installata e consentita, completa le azioni quando si utilizza [!UICONTROL Desktop Actions] dall&#39;interfaccia Web  Experience Manager. L&#39;app scarica prima la risorsa e quindi completa l&#39;azione.
